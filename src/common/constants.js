...
module.exports = {
  ...
  HWW_STATE: {
    ...
    ONLINE: 'online',  // After PIN but before Monoeci app (usually after "add" event).
    AVAILABLE: 'available',  // inside Monoeci app but not yet confirmed subaccount.
    READY: 'ready',  // inside Monoeci app and selected subaccount.
  },
